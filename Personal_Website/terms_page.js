var DATA = [{
    "name": "Git",
    "description": " Git is a distributed version - control system for tracking changes in source code during software development.Version Control - The management of changes to documents,computer programs,    large web sites,and other collections of information.",
    "related": ["Module 6"],
    "synonyms": []
  },
  {
    "name": "Centralized Model",
    "description": "A Centralized Training Organization is one that organizes the training function into a single or central group within the enterprise.",
    "related": ["Module 6"]
  },
  {
    "name": "Distributed Model",
    "description": " Defines a way of contact in between the components of a system and it refers to how resources are spread out and works on more than one device to improve the effectiveness and performance of a task.",
    "related": ["Module 6"]
  },
  {
    "name": "Zip Files",
